...
window.onload = function (ev) {
    ...
    //TODO dana: ajax query to get ids
    if (current_role === "gm") {
        $('#magic_ico').on('click', function () {
            ...
            //TODO dana: ajax query or another gm ajax query
            setTimeout(function () {
...
function renderInfo(cId){
    ...
    if (current_role === "gm") {
        ...
        //TODO dana: ajax query to get all avaliable conditions with pers sex
        //!!!!!!!!!!!!!!!!!!
...
function sendMessage() {
    ...
    //let user = getUser();
    //TODO dana ДЕНИС ЭТО ВЫГЛЯДИТ КАК ПЛАН: ajaxSendMessage(user, message);
    //let newP = document.createElement("p");
...
function fieldClick(x, y) {
    ...
    coordinates[0] = [x, y];
    drawSpot();
    //TODO dana: ajaxRequest(username, x, y);
...
function getAllItemsAjax() {
    return $.ajax({
        url: 'http://localhost:8080/ItemController/findall',//TODO
        type: 'GET',
        dataType: 'json',
        async: false,
...
function getPersItemsAjax(pId) {
    return $.ajax({
        url: 'http://localhost:8080/character/getCharacterItems',//TODO
        type: 'GET',
        dataType: 'json',
        data: {
            id: pId
...
function buyItemAjax(name) {
    return $.ajax({
        url: 'http://localhost:8080/character/buyItem',//TODO
        type: 'GET',
        dataType: 'json',
        data: {
            character_id: myPId,
...
function addItemAjax(cId, name, iDesc, iPrice, iWeight) {
    return $.ajax({
        url: 'http://localhost:8080/character/addItemToCharacter',//TODO
        type: 'GET',
        dataType: 'json',
        data: {
            character_id: cId,
...
function sellItemAjax(name) {
    return $.ajax({
        url: 'http://localhost:8080/character/removeItemFromCharacter',//TODO
        type: 'GET',
        dataType: 'json',
        data: {
            character_id: myPId,
...
function getPersMoneyAjax(pId) {
    let curAjax = $.ajax({
        url: 'http://localhost:8080/character/getMoney',//TODO
        type: 'GET',
        async: false,
        data: {
            id: pId
...
function setPersMoneyAjax(pId) {
    let curAjax = $.ajax({
        url: 'http://localhost:8080/character/setMoney',//TODO
        type: 'GET',
        async: false,
        data: {
            id: pId
...
function getPersInfoAjax(pId) {
    return $.ajax({
        url: 'http://localhost:8080/character/getCharacterInfo',//TODO
        type: 'GET',
        dataType: 'json',
        data: {
            id: pId
...
function getPersPerksAjax(pId, name, description, p_a) {
    return $.ajax({
        url: 'http://localhost:8080/character/addAbilityToCharacter',//TODO
        type: 'GET',
        dataType: 'json',
        data: {
            character_id: pId,
...
function removePerkAjax(pId, name) {
    return $.ajax({
        url: 'http://localhost:8080/character/removeAbilityFromCharacter',//TODO
        type: 'GET',
        dataType: 'json',
        data: {
            character_id: pId,
...
function getMyPerksAjax(pId) {
    return $.ajax({
        url: 'http://localhost:8080/character/getCharacterAbilities',//TODO
        type: 'GET',
        dataType: 'json',
        data: {
            id: pId
...
function getAllPerksAjax(pId) {
    return $.ajax({
        url: 'http://localhost:8080/AbilityController/findall',//TODO
        type: 'GET',
        dataType: 'json',
        async: false,
        success: function(response){
...
function getAllEffectsAjax(pId) {
    return $.ajax({
        url: 'http://localhost:8080/EffectController/findall',//TODO
        type: 'GET',
        dataType: 'json',
        async: false,
        success: function(response){
...
function getPersEffectsAjax(pId) {
    return $.ajax({
        url: 'http://localhost:8080/character/getCharacterEffects',//TODO
        type: 'GET',
        dataType: 'json',
        async: false,
        data: {
...
function addEffectAjax(pId, name,  desc) {
    return $.ajax({
        url: 'http://localhost:8080/character/addEffectToCharacter',//TODO
        type: 'GET',
        dataType: 'json',
        data: {
            character_id: pId,
